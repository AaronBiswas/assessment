...
const Agents = () => {
  ...
  return (
    <div className="bg-gray-900 bg-opacity-80 rounded-2xl shadow-2xl py-8 px-4 mb-8">
      <h2 className="text-3xl font-bold text-indigo-400 mb-8 text-center drop-shadow">
        Agents
      </h2>
        ...
        {agent.length === 0 ? (
          ...
          agent.map((agents) => (
            ...
            >
              ...
              <ul className="w-full mt-4 bg-gray-900 bg-opacity-70 rounded-lg p-3">
                {agents.tasks.length === 0 ? (
                  ...
                  agents.tasks.map((item, i) => {
                    ...
                    return (
                      <li
                        key={i}
                        className="text-gray-200 py-2 px-3 rounded hover:bg-indigo-800/40 transition-colors mb-2 border-l-4 border-indigo-500 flex flex-col gap-1"
                      >
                        <span>
